...
window.addEventListener('mouseup', function(event){
    if(event.target != modal && event.target.parentNode != form1) {
        modal.style.display = 'none';
        form1.reset();
    }
})
...
// const forminput2 = document.getElementById('pass')

// inptbtn.addEventListener('click', function(event){
//     event.preventDefault()
    
// });
// let inputsss = document.querySelectorAll('#form1 input');
// for(let i = 0; i < inputsss.length; i++){
//     function IsEmpty() {
//         if (inputsss[i].value.length == 0){
//             inputsss[i].value = 'Required';   
//         }else {
//             modal.style.display = 'none';
//         }
//       };
...
// forminput.addEventListener('input', onClick())
// forminput2.addEventListener('input', onClick())
